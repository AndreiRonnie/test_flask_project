...
def get_default_system_history() -> list:
    system_message = {
        ...
        "content": (
            ...
            "выясни требуемый процент уникальности и систему проверки: подойдет ли бесплатная проверка по txt или будет проверка по АнтиплагиатВУЗ.\n\n"
            ...
            "По экономическим дисциплинам цена в 1.5 раза выше, а по техническим (точным) — в 2 раза выше.\n\n"
