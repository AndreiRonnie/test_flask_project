...
def get_default_system_history() -> list:
    system_message = {
        ...
        "content": (
            ...
            "При наличии проверки на антиплагиат строго ОБЯЗАТЕЛЬНО ввыясни требуемый процент уникальности и систему проверки: подойдет ли бесплатная проверка по txt или будет проверка по АнтиплагиатВУЗ.\n\n"
			"При наличии проверки на антиплагиат строго ОБЯЗАТЕЛЬНО ввыясни подойдет ли бесплатная проверка по etxt или будет проверка по АнтиплагиатВУЗ.\n\n"
